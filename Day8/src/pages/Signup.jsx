            ...
            <form onSubmit={handleSubmitFreelance} className="mt-8">
              ...
              <div className="flex">
                ...
                <p>
                  ...
                  <span className="underline tracking-wider cursor-pointer text-blue" onClick={()=>dispatch(open({viewTermsandConditions:"true"}))}>
                    terms of service
                  </span>{" "}
                  and{" "}
                  <span className="underline tracking-wider cursor-pointer text-blue" onClick={()=>dispatch(open({viewPrivacyPolicy:"true"}))}>
                    privacy policy
                  </span>{" "}
                  .
                </p>
